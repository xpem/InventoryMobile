...
namespace ApiDAL
{
    ...
    {
        Task<ApiResponse> AuthRequestAsync(RequestsTypes requestsType, string url, Object? content = null);
    ...
    public class HttpClientFunctions(InventoryDbContextDAL inventoryDbContextDAL) : HttpClient, IHttpClientFunctions
    {
        ...
        public virtual async Task<ApiResponse> RequestAsync(RequestsTypes requestsType, string url, string? userToken = null, Object? content = null)
        {
            try
            {
                HttpClient httpClient = new();
        ...
        public async Task<ApiResponse> AuthRequestAsync(RequestsTypes requestsType, string url, Object? content = null)
        {
            bool retry = true;
